...
\title{INDICES MUNDIALES}
% autores
\renewcommand\Authand{, y }
\author[1]{\normalsize Andres Esteban Acero}
\author[2]{\normalsize Cesar Rojas}

\affil[1,2]{\small  Facultad de Ingeniería,Universidad de los Andes\\
\texttt{{ae.acero539,ce.rojas10}@uniandes.edu.co}}
...
% Date and time: vie, jun 29, 2018 - 03:02:49 p.m.
